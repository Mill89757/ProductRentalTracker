        ...
        <div className="text-center">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900">Product Management</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900">Rental Tracking</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-lg font-semibold mb-2 text-gray-900">Real-time Status</h3>
